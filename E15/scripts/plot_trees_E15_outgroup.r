...
# E15 trees outgroup
tree_error <- "../beast/E15_rskycoal_em_summary.trees"

tree_no_error <- "../beast/E15_rskycoal_summary.trees"
...
ggsave('../figures/E15_gt16_outgroup_error_tree.pdf', width = 6, height = 4, units = c("in"))
...
ggsave('../figures/E15_gt16_outgroup_no_error_tree.pdf', width = 6, height = 4, units = c("in"))
