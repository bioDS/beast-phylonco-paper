...
# L86 trees no outgroup
tree_error <- "../beast/L86_rskycoal_em_summary.trees"

tree_no_error <- "../beast/L86_rskycoal_summary.trees"
...
ggsave('../figures/L86_gt16_error_tree.pdf', width = 8, height = 7.5, units = c("in"))
...
ggsave('../figures/L86_gt16_no_error_tree.pdf', width = 8, height = 7.5, units = c("in"))
